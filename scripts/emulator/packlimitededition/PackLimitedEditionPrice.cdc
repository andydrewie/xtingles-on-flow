...
pub fun main(address:Address, id: UInt64): UFix64?? {
    ...
    let acctOpenEditionRef = acct.getCapability<&AnyResource{PackLimitedEdition.LimitedEditionCollectionPublic}>(PackLimitedEdition.LimitedEditionCollectionPublicPath)
        .borrow()
