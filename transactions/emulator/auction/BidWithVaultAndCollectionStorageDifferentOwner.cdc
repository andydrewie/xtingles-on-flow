...
transaction(       
    ...
    prepare(acct: AuthAccount) {
        ...
        // Different account for vault capability to return money back
        let fakeAcct = getAccount(Address(0x179b6b1cb6755e31))

        self.vaultCap = fakeAcct.getCapability<&{FungibleToken.Receiver}>(/public/fusdReceiver)
