...
export const testSuiteCancelOpenEdition = () => describe("Open Edition cancel", () => {
    ...
    beforeAll(async () => {
        ...
        settleTransaction = fs.readFileSync(
            path.join(
                __dirname,
                `../../transactions/emulator/openeditionV3/SettleOpenEdition.cdc`
            ),
            "utf8"
        );  
    ...
    test("successfull case of cancel open edition", async () => { 
        ...
        try {
            ...
            expect(events[1].type).toEqual(`A.${admin.substr(2)}.OpenEditionV3.Canceled`);
