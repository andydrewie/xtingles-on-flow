...
export const testSuiteBidAuction = () => describe("Auction bid", () => {
  ...
  beforeAll(async () => {
    ...
    placeBidWithoutNFTStorageTransaction = fs.readFileSync(
      path.join(
        __dirname,
        `../../transactions/emulator/auctionV2/BidWithoutNFTStorage.cdc`
      ),
      "utf8"
    );
    ...
    bidWithFakeReturnVaultCapTransaction = fs.readFileSync(
      path.join(
        __dirname,
        `../../transactions/emulator/auctionV2/BidWithFakeReturnVaultCap.cdc`
      ),
      "utf8"
    );
    ...
    bidWithVaultAndCollectionStorageDifferentOwner = fs.readFileSync(
      path.join(
        __dirname,
        `../../transactions/emulator/auctionV2/BidWithVaultAndCollectionStorageDifferentOwner.cdc`
      ),
      "utf8"
    );
  });
